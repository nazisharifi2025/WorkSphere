...
I'm always excited to connect with creative minds and explore new opportunities to learn and grow.
        ...
        <div className="  lg:right-22 md:right-44 right-0 lg:bottom-25 bottom-14   absolute  rounded-full  h-[414px] flex justify-center items-center w-[414px] bg-gradient-to-tr from-text-nav to-black animate-spin-slow">
          </div>    
