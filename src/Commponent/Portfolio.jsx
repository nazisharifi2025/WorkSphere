...
<button className='py-2 px-6 bg-nav text-black w-fit'>Learn More</button>
            ...
            <div className='h-[50vh] absolute z-40 -bottom-24 border-8   right-10 w-[550px] bg-cover bg-no-repeat bg-center bg-[url(public/Images/charity.jpg)] '></div>
        </div>
        </div>
        {/* one div ended */}
...
<button className='py-2 px-6 bg-black text-nav w-fit'>Learn More</button>
            ...
            <div className='h-[50vh] z-40 absolute -bottom-24 border-8  left-10 w-[550px] bg-cover bg-no-repeat bg-center bg-[url(public/Images/doctor.jpg)] '></div>
        </div>
        </div>
        {/* div 2 endded */}
        <div className='h-[80vh] w-full relative bg-black flex justify-between items-center font-web text-nav'>
...
<button className='py-2 px-6 bg-nav text-black w-fit'>Learn More</button>
            ...
            <div className='h-[50vh] absolute z-40 -bottom-24 border-8 text-nav right-10 w-[550px] bg-cover bg-no-repeat bg-center bg-[url(public/Images/home.jpg)] '></div>
        </div>
        </div>
    </section>
  )
